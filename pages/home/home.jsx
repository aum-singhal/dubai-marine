...
import SectionWithTitleChildren from "../../components/molecules/sectionWithTitleChildren";
import { useState } from "react";
import { styles } from "./home.style";
import { Colors } from "react-native/Libraries/NewAppScreen";
import SimpleCardWithImage from "../../components/atoms/simpleCardWithImage/simpleCardWithImage";
  ...
  return <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={{paddingBottom:30}} style={{flex: 1,height: "100%", padding: 10}}>
    ...
    <View style={{flexDirection: "row", marginBottom: 15, justifyContent:"space-between"}}>
        ...
        <View style={{flexDirection:"row", gap: 10}}>
          <TouchableOpacity style={styles.headerCards} onPress={()=>navigation.navigate("Scanner")}>
